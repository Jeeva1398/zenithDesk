...
// Content-Type the uploader sent - both are whatever the uploader wanted them
// to be. Anything that matches none of these is refused, which is also what
// keeps HTML and SVG (script carriers) out.
const SIGNATURES = [
...
/** Returns { type, mime } for a recognised file, or null. */
...
// Keeps the name an agent will recognise, minus anything that could act as a
// path or break a Content-Disposition header.
